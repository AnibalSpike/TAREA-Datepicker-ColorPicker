...
public class Calendario extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Crear la primera pestaña (Tab) y añadir el VBox
        Tab tab1 = new Tab("Selección", vbox);
        tab1.setClosable(false); // Evitar que la pestaña se pueda cerrar

        // Crear un VBox para la segunda pestaña (mostrar resultados)
        ...
        submitButton.setOnAction(event -> {
            ...
            String selectedColor = colorPicker.getValue() != null ? colorPicker.getValue().toString() : "Null";
        ...
        primaryStage.setTitle("Mostrar fecha  y seleccionar el color");
